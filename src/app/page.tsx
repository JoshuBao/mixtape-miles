    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <video autoPlay loop muted className="absolute inset-0 w-full h-full object-cover z-0">
          <source src="/road-trip-video.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-30 text-center text-white p-6 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link 
              href="/stories" 
              className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-bold py-4 px-8 rounded-full hover:from-purple-700 hover:to-indigo-700 transition duration-300 transform hover:scale-105 shadow-lg"
            >
        ...
        <div className="absolute -bottom-20 -right-20 w-80 h-80 z-20 opacity-70">
          <div className="w-full h-full rounded-full bg-black border-8 border-gray-900 shadow-2xl animate-spin-slow">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-gradient-to-r from-purple-400 to-indigo-500"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto">
          ...
          <div className="relative">
            <div className="absolute -top-4 -left-4 w-20 h-20 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center transform -rotate-12 z-10">
              <span className="text-3xl">🎵</span>
            </div>
            
            <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-pink-100 dark:bg-pink-900 rounded-full flex items-center justify-center transform rotate-12 z-10">
              <span className="text-2xl">🚐</span>
            </div>
            
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-4 transform transition duration-500 hover:shadow-2xl relative z-0">
              <MapComponent />
            </div>
          </div>
          
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 transform transition duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">Explore Journeys</h3>
              </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 transform transition duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">Discover Stories</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md p-6 transform transition duration-300 hover:shadow-lg hover:-translate-y-1">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-800 dark:text-white">Listen to Songs</h3>
              </div>
              <p className="text-gray-600 dark:text-gray-300">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-10">
            <div className="inline-block mb-4 relative">
              <div className="w-16 h-16 rounded-full bg-gradient-to-r from-yellow-400 to-yellow-500 flex items-center justify-center mx-auto">
          ...
          <div className="bg-white dark:bg-gray-900 shadow-xl rounded-2xl overflow-hidden transform transition duration-500 hover:shadow-2xl">
            <div className="md:flex">
              <div className="md:w-2/5 relative">
                <div className="h-72 md:h-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center relative overflow-hidden">
              ...
              <div className="p-8 md:w-3/5">
                <div className="bg-yellow-50 dark:bg-yellow-900/30 px-4 py-2 rounded-lg inline-block mb-4">
                  <div className="text-yellow-700 dark:text-yellow-400 text-sm font-semibold flex items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <div className="text-gray-500 dark:text-gray-400 text-sm mb-1">Current Playlist</div>
                    <div className="text-gray-900 dark:text-gray-100 font-bold text-xl flex items-center">
                  ...
                  {latestStory && (
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                      <div className="text-gray-500 dark:text-gray-400 text-sm mb-1">Latest Addition</div>
                      <div className="text-gray-900 dark:text-gray-100 font-bold">"{latestStory.songTitle}"</div>
                ...
                <div className="flex">
                  <Link href="/trips/berkeley-oregon" className="flex items-center bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-3 px-6 rounded-lg hover:from-indigo-600 hover:to-purple-700 transition duration-300 shadow-md transform hover:scale-105">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <div className="inline-block mb-4">
              <span className="w-12 h-12 rounded-full bg-indigo-100 dark:bg-indigo-900 flex items-center justify-center mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {recentStories.map(story => (
              <div 
                key={story.id} 
                className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transform transition duration-300 hover:shadow-xl hover:-translate-y-2"
              >
                <div className="p-1">
                  <div className="h-40 bg-gradient-to-r from-indigo-400 to-purple-500 rounded-t-lg flex items-center justify-center">
                  ...
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-300 text-xs px-3 py-1 rounded-full">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg mb-4">
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">"{story.songTitle}"</p>
                      <p className="text-gray-600 dark:text-gray-300 text-sm">by {story.artist}</p>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Link href={`/stories/${story.slug || story.id}`} className="text-indigo-600 dark:text-indigo-400 font-medium hover:text-indigo-700 dark:hover:text-indigo-300 inline-flex items-center">
                        Read more
          ...
          <div className="text-center mt-12">
            <Link href="/stories" className="inline-block bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-4 px-8 rounded-full hover:from-indigo-600 hover:to-purple-700 transition duration-300 shadow-lg transform hover:scale-105">
              View All Stories
            </Link>
          </div>
        </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
            <div className="h-48 bg-indigo-100 dark:bg-indigo-900 relative">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-600">
                <span className="text-white text-3xl font-bold">CURRENT TRIP</span>
              </div>
            </div>
            <div className="p-6">
              ...
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Berkeley to Oregon</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6">
              ...
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">San Diego to San Francisco</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
            <div className="h-48 bg-gray-100 dark:bg-gray-700 relative">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-gray-500 to-gray-600">
                <span className="text-white text-3xl font-bold">PLANNED</span>
              </div>
            </div>
            <div className="p-6">
              <span className="inline-block px-3 py-1 mb-4 text-xs font-semibold text-gray-800 bg-gray-200 dark:text-gray-200 dark:bg-gray-800 rounded-full">July 2023</span>
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">New Orleans to Nashville</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
            <div className="h-48 bg-gray-100 dark:bg-gray-700 relative">
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-r from-teal-500 to-emerald-500">
                <span className="text-white text-3xl font-bold">VOTE NOW</span>
              </div>
            </div>
            <div className="p-6">
              ...
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">You Decide Our Next Trip!</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Help us choose our next route and theme.
              </p>
              <div className="flex justify-between items-center">
                <span className="text-gray-500 dark:text-gray-400">Vote Now!</span>
